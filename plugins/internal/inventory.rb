...
on_player_login(:inventory) {|player|
  player.inventory.add_listener Lapidary::Item::InterfaceContainerListener.new(player, 3214)
  player.inventory.add_listener Lapidary::Item::WeightListener.new(player)
}
