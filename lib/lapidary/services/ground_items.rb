module Lapidary::GroundItems
  class GroundItem
    ...
    def initialize(player, item, on_table = false)
      ...
      @available = true
      @global = false
      @life = Lapidary::GroundItems::GroundItemEvent.new self
      @on_table = on_table
  ...
  class GroundItemEvent < Lapidary::Engine::Event
    attr :item
  ...
  class PickupItemAction < Lapidary::Engine::Action
    attr :item
    ...
    def queue_policy
      Lapidary::Engine::QueuePolicy::NEVER
    end
