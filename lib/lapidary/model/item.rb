module Lapidary::Item
  ...
  class WeightListener < ContainerListener
    ...
    def update_weight
      ...
      @player.connection.send_data Lapidary::Net::PacketBuilder.new(240).add_short(weight.to_i).to_packet
    end
  ...
  class BonusListener < ContainerListener
    ...
    def equipment_bonus(id)
      ...
      when Symbol
        id
      when Integer
        Lapidary::Item::ItemDefinition::PROPERTIES[id + 9]
      end
