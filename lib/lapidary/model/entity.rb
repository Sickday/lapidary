module Lapidary::Model
  class Entity
    DEFAULT_LOCATION = Lapidary::Model::Location.new 2887, 10224, 0
    ...
    def initialize
      @flags = Lapidary::Misc::Flags.new
      @agressor = false
      @cool_downs = Lapidary::Misc::Flags.new
      @local_players = []
      @local_npcs = []
      ...
      @region_change = false
      @teleporting = false
      @walking_queue = Lapidary::World::Pathfinder.new self
